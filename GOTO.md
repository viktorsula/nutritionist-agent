...
- **Дальше:** кабинет нутрициолога (Фаза 3) — карточка клиента (профиль/планы/задачи),
  реестр клиентов, запросы к агенту (analytics/management через /nutritionist/query).
