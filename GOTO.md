...
- **Дальше по Фазе 3:** запросы нутрициолога к агенту через `/nutritionist/query`
  (analytics/management уже на бэке) — UI чата/запроса в кабинете; редактор планов/задач/ЗОЖ;
  вкладка «Аналитика» и «Настройки» (пороги/источники/промпты) на React.
