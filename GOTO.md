...
- **Дальше по Фазе 3:** редактор планов питания/задач/ЗОЖ (создание через UI, не только чатом);
  вкладки «Аналитика» (дашборды) и «Настройки» (пороги/источники/промпты) на React.
