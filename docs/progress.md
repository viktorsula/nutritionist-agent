...
## Статус: В разработке → ПРОД (#71–#73 влиты; еженедельный автоотчёт нутрициологу реализован — ТЗ 6.2.1)
Последнее обновление: 7 июля 2026
Сессия: инцидент миграции 016 + гигиена реестра + сверка с ТЗ + еженедельный автоотчёт (ТЗ 6.2.1)
