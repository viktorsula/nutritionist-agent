...
## Статус: В разработке → все LEGAL/P0 из мастер-списка устранены (LEGAL-2 осознанно отложена); дальше P1/P2/NEW-1
Последнее обновление: 24 июля 2026
Сессия: закрытие всех блокеров P0/LEGAL по одному PR за раз (PR-D web_search, LEGAL-1 согласие,
P0-4 tool-calling провайдеров, LEGAL-3 soft-delete) + прод-инцидент (непринятая миграция 018)
