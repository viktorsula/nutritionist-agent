...
Сессия: восстановление после резкой остановки 24 июня (push + аудит настроек №6 + синхронизация доков)
Ветка: рабочая `stage6-utils` (запушена в origin; не влита в main)
